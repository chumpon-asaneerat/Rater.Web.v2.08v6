...
gulp.task('db-script-2018-05-18', function () {
    var sDate = '2018-05-18'
    var rootPath = 'db/scripts/' + sDate;
    var src = [
        /* Concat all *.sql file in subdirectories. */
        rootPath + '/**/*.sql',
...
gulp.task('db-script-2018-05-25', function () {
    var sDate = '2018-05-25'
    var rootPath = 'db/scripts/' + sDate;
    var src = [
        /* Concat all *.sql file in subdirectories. */
        rootPath + '/**/*.sql',
...
gulp.task('db-script-2018-05-26', function () {
    var sDate = '2018-05-26'
    var rootPath = 'db/scripts/' + sDate;
    var src = [
        /* Concat all *.sql file in subdirectories. */
        rootPath + '/**/*.sql',
...
gulp.task('db-script-2018-06-01', function () {
    var sDate = '2018-06-01'
    var rootPath = 'db/scripts/' + sDate;
    var src = [
        /* Concat all *.sql file in subdirectories. */
        rootPath + '/**/*.sql',
...
gulp.task('db-script-2018-06-09', function () {
    var sDate = '2018-06-09'
    var rootPath = 'db/scripts/' + sDate;
    var src = [
        /* Concat all *.sql file in subdirectories. */
        rootPath + '/**/*.sql',
