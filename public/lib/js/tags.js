...
riot.tag2('page-footer', '<span class="float-left m-0 p-0" style="font-size: 0.7em;"> &nbsp;&nbsp;Status.&nbsp; <div class="v-divider">&nbsp;</div> </span> <span class="float-right m-0 p-0 ml-auto"> <div class="v-divider">&nbsp;</div> &copy;&nbsp;EDL co.th.&nbsp;&nbsp;&nbsp;&nbsp; </span>', 'page-footer,[data-is="page-footer"],page-footer nav,[data-is="page-footer"] nav,page-footer span,[data-is="page-footer"] span,page-footer .navbar-text,[data-is="page-footer"] .navbar-text{ color: whitesmoke; font-size: 0.8em; margin: 0 auto; } page-footer .v-divider,[data-is="page-footer"] .v-divider{ display: inline; margin-left: 5px; margin-right: 5px; border-left: 1px solid whitesmoke; }', 'class="navbar fixed-bottom m-0 p-1 navbar-light bg-primary"', function(opts) {
});
