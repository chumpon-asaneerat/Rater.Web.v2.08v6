...
riot.tag2('default-home-dashboard', '<div data-is="sidebars" class="sidebars"> <div data-is="sidebar" icon="apple" text="Menu 1"></div> <div data-is="sidebar" icon="android" text="Menu 2" active="true"></div> <div data-is="sidebar" icon="apple" text="Menu 3"></div> <div data-is="sidebar" icon="android" text="Menu 4"></div> <div data-is="sidebar" icon="apple" text="Menu 5"></div> <div data-is="sidebar" icon="android" text="Menu 6"></div> <div data-is="sidebar" icon="apple" text="Menu 7"></div> <div data-is="sidebar" icon="android" text="Menu 8"></div> <div data-is="sidebar" icon="apple" text="Menu 9"></div> <div data-is="sidebar" icon="android" text="Menu 10"></div> <div data-is="sidebar" icon="apple" text="Menu 11"></div> <div data-is="sidebar" icon="android" text="Menu 12"></div> <div data-is="sidebar" icon="apple" text="Menu 13"></div> <div data-is="sidebar" icon="android" text="Menu 14"></div> <div data-is="sidebar" icon="apple" text="Menu 15"></div> <div data-is="sidebar" icon="android" text="Menu 16"></div> <div data-is="sidebar" icon="apple" text="Menu 17"></div> <div data-is="sidebar" icon="android" text="Menu 18"></div> <div data-is="sidebar" icon="apple" text="Menu 19"></div> <div data-is="sidebar" icon="android" text="Menu 20"></div> <div data-is="sidebar" icon="apple" text="Menu 21"></div> <div data-is="sidebar" icon="android" text="Menu 22"></div> <div data-is="sidebar" icon="apple" text="Menu 23"></div> <div data-is="sidebar" icon="android" text="Menu 24"></div> <div data-is="sidebar" icon="apple" text="Menu 25"></div> </div> <div data-is="dashboard-content" class="dashboard-content"> <yield></yield> </div>', 'default-home-dashboard .sidebars,[data-is="default-home-dashboard"] .sidebars{ position: absolute; top: 1px; left: 1px; bottom: 1px; width: 150px; } default-home-dashboard .dashboard-content,[data-is="default-home-dashboard"] .dashboard-content{ position: absolute; top: 1px; left: 152px; right: 2px; bottom: 1px; }', '', function(opts) {
});

riot.tag2('sidebars', '<div class="sidebars-container" data-simplebar> <yield></yield> </div>', 'sidebars,[data-is="sidebars"]{ border: 1px solid silver; margin: 0 auto; } sidebars .sidebars-container,[data-is="sidebars"] .sidebars-container{ position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; width: 150px; overflow-x: hidden; overflow-y: auto; }', '', function(opts) {
});

riot.tag2('sidebar', '<a href="javascript:void(0);" class="d-inline item {(active === \'true\') ? \'active\' : \'\'}"> <span class="m-auto item-icon fab fa-{icon}"></span> <p class="item-text d-inline-block m-auto">{text}</p> </a>', 'sidebar a,[data-is="sidebar"] a{ text-decoration-line: none; } sidebar .item,[data-is="sidebar"] .item{ height: 56px; margin: 0px auto; padding-left: 3px; padding-top: 7px; padding-bottom: 6px; padding-right: 1px; color: whitesmoke; background: cornflowerblue; border-radius: 0; overflow: hidden; } sidebar .item:hover,[data-is="sidebar"] .item:hover{ background: forestgreen; } sidebar .active,[data-is="sidebar"] .active{ color: yellow; background: darkgreen; } sidebar .item-icon,[data-is="sidebar"] .item-icon{ width: 1.2em; padding: 3px; padding-left: 5px; font-size: 1.1rem; } sidebar .item-text,[data-is="sidebar"] .item-text{ margin: 0 auto; padding: 4px; padding-right: 1px; font-size: 1.1em; width: 120px; white-space: nowrap; }', '', function(opts) {
        this.icon = opts.icon;
        this.text = opts.text;
        this.active = opts.active;
});

riot.tag2('dashboard-content', '<yield></yield>', 'dashboard-content,[data-is="dashboard-content"]{ border: 1px solid silver; }', '', function(opts) {
});
