 ...
 * @param {any} callback 
 */
function GetMemberDescription(pObj, callback) {
    var spName = 'GetMemberDescription';
    var dbdef = new mssqldb.msSqldb(spName);
    // Execute
    dbdef.Execute(pObj, callback);
};

exports.GetMemberDescription = module.exports.GetMemberDescription = GetMemberDescription;
